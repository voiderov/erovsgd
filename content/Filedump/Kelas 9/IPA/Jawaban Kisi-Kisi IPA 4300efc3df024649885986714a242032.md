...
**Perubahan fisika** adalah [perubahan](https://id.wikipedia.org/wiki/Perubahan) yang terjadi pada suatu [zat](https://id.wikipedia.org/wiki/Zat) atau [materi](https://id.wikipedia.org/wiki/Materi) tanpa disertai terbentuk zat baru. Dengan kata lain, hasil perubahan tersebut masih memiliki [sifat fisika](https://id.wikipedia.org/wiki/Sifat_fisika) yang sama dengan zat awalnya, perubahan hanya terjadi pada bentuk, warna, ukurannya saja (fisik). Ada tiga keadaan utama materi - [padat](https://id.wikipedia.org/wiki/Padat), [cair](https://id.wikipedia.org/wiki/Cair), dan [gas](https://id.wikipedia.org/wiki/Gas). Perubahan fisika terjadi ketika zat dicampur tetapi tidak [bereaksi](https://id.wikipedia.org/wiki/Reaksi_kimia) secara kimiawi.

Semua perubahan [wujud zat](https://id.wikipedia.org/wiki/Wujud_zat) ([mencair](https://id.wikipedia.org/wiki/Mencair), [meleleh](https://id.wikipedia.org/wiki/Mencair), [melebur](https://id.wikipedia.org/wiki/Peleburan), [menguap](https://id.wikipedia.org/wiki/Penguapan), [mendidih](https://id.wikipedia.org/wiki/Mendidih), [menyublim](https://id.wikipedia.org/wiki/Menyublim), atau [membeku](https://id.wikipedia.org/wiki/Membeku)) merupakan perubahan fisika. Pembekuan cairan adalah perubahan fisika. [Pemotongan](https://id.wikipedia.org/wiki/Pemotongan), robekan, [penghancuran](https://id.wikipedia.org/w/index.php?title=Penghancuran&action=edit&redlink=1), [penggilingan](https://id.wikipedia.org/w/index.php?title=Penggilingan&action=edit&redlink=1), dan [pencampuran](https://id.wikipedia.org/wiki/Pencampuran) adalah jenis perubahan fisika lebih lanjut karena mereka mengubah bentuk tetapi bukan komposisi material.

### Ciri-Ciri

Perubahan fisika pada suatu zat melibatkan perubahan [sifat fisika](https://id.wikipedia.org/wiki/Sifat_fisika). Berikut ini adalah beberapa ciri-ciri yang terdapat pada perubahan fisika:

### Tidak terbentuk zat baru

Ciri pertama dari perubahan fisika adalah hasil perubahannya bukan merupakan zat kimia baru. Meskipun tampilannya telah berubah dari bentuk semula,tetapi sifat zat hasil perubahan tersebut masih tetap sama dengan zat awalnya. Zat hanya mengubah [keadaan fisiknya](https://id.wikipedia.org/w/index.php?title=Keadaan_fisik&action=edit&redlink=1), misalnya dari padat menjadi cair. Selain itu, [pemanasan](https://id.wikipedia.org/wiki/Pemanasan) pada zat-zat tertentu juga dapat menyebabkan perubahan fisika di mana tidak ada zat atau zat baru yang terbentuk.

### Dapat kembali ke bentuk semula (Reversible)

Ciri kedua dari perubahan fisika adalah hasil perubahannya dapat kembali ke bentuk semula ([reversible](https://id.wikipedia.org/w/index.php?title=Reversibel&action=edit&redlink=1)), terutama [perubahan fase](https://id.wikipedia.org/w/index.php?title=Perubahan_fase&action=edit&redlink=1). Misalnya air yang membeku menjadi mencair kembali menjadi air. Tidak semua perubahan fisika mudah dibalik dan bahkan yang lainnya tidak. Namun, reversibilitas biasanya menunjukkan perubahan fisika.

### Sifat fisik zat yang telah berubah

Ciri ketiga dari perubahan fisika adalah perubahan hanya terjadi pada sifat fisik zat saja. Sifat fisik zat terdiri dari [wujud](https://id.wikipedia.org/wiki/Wujud_materi), [warna](https://id.wikipedia.org/wiki/Warna), [bau](https://id.wikipedia.org/wiki/Bau), [titik leleh](https://id.wikipedia.org/wiki/Titik_leleh), [titik didih](https://id.wikipedia.org/wiki/Titik_didih), [massa jenis](https://id.wikipedia.org/wiki/Massa_jenis), [kekerasan](https://id.wikipedia.org/wiki/Kekerasan), [kelarutan](https://id.wikipedia.org/wiki/Kelarutan), [kekeruhan](https://id.wikipedia.org/wiki/Kekeruhan), [kemagnetan](https://id.wikipedia.org/wiki/Magnet), dan [kekentalan](https://id.wikipedia.org/wiki/Kekentalan).

### Tidak terjadi reaksi kimia

Perubahan fisika tidak menyebabkan suatu zat menjadi zat yang berbeda secara [fundamental](https://id.wikipedia.org/wiki/Fundamental), tetapi [perubahan kimiawi](https://id.wikipedia.org/wiki/Perubahan_kimia) menyebabkan zat berubah menjadi zat baru secara [kimiawi](https://id.wikipedia.org/wiki/Kimia).

### Bentuk-Bentuk

### Sifat fisika

Perubahan fisika terbatas pada perubahan yang menghasilkan perbedaan tampilan tanpa mengubah [komposisi](https://id.wikipedia.org/w/index.php?title=Komposisi&action=edit&redlink=1). Beberapa perubahan umum (tetapi tidak terbatas pada) adalah:

- [Tekstur](https://id.wikipedia.org/w/index.php?title=Tekstur&action=edit&redlink=1)
- [Warna](https://id.wikipedia.org/wiki/Warna)
- [Suhu](https://id.wikipedia.org/wiki/Suhu)
- [Bentuk](https://id.wikipedia.org/wiki/Bentuk)
- Perubahan keadaan ([titik didih](https://id.wikipedia.org/wiki/Titik_didih) dan [titik leleh](https://id.wikipedia.org/wiki/Titik_leleh) merupakan faktor penting dalam menentukan perubahan ini).

Sifat fisika mencakup banyak aspek lain dari suatu zat. Berikut ini adalah sifat fisika:

- [Kilau](https://id.wikipedia.org/wiki/Cahaya)
- [Sifat lunak](https://id.wikipedia.org/w/index.php?title=Kelunakan&action=edit&redlink=1)
- Kemampuan untuk ditarik menjadi [kawat](https://id.wikipedia.org/wiki/Kawat) tipis
- [Massa jenis](https://id.wikipedia.org/wiki/Massa_jenis)
- [Viskositas](https://id.wikipedia.org/wiki/Viskositas)
- [Kelarutan](https://id.wikipedia.org/wiki/Kelarutan)
- [Massa](https://id.wikipedia.org/wiki/Massa)
- [Volume](https://id.wikipedia.org/wiki/Volume)

Setiap perubahan pada [sifat fisika](https://id.wikipedia.org/wiki/Sifat_fisika) ini disebut perubahan fisika.

### Perubahan wujud zat

[Perubahan fase](https://id.wikipedia.org/w/index.php?title=Perubahan_fase&action=edit&redlink=1) adalah perubahan yang terjadi sat zat meleleh, membeku, merebus, dipadatkan, disublimasikan, atau disimpan. Perubahan ini merupakan perubahan fisika karena tidak mengubah sifat substansi.

### Mencair

[Mencair](https://id.wikipedia.org/wiki/Mencair) adalah peristiwa perubahan wujud zat dari [padat](https://id.wikipedia.org/wiki/Padat) menjadi [cair](https://id.wikipedia.org/wiki/Cair) dengan mengandalkan [energi panas](https://id.wikipedia.org/wiki/Energi_panas). Contohnya [es](https://id.wikipedia.org/wiki/Es) batu menjadi air, [lilin](https://id.wikipedia.org/wiki/Lilin) meleleh, dan mentega yang dipanaskan.

### Membeku

[Membeku](https://id.wikipedia.org/wiki/Membeku) adalah peristiwa perubahan wujud zat dari cair menjadi padat, dalam peristiwa ini zat akan melepaskan energi panas. Contohnya air menjadi es dan [logam](https://id.wikipedia.org/wiki/Logam) cair yang membeku.

### Mengkristal

[Mengkristal](https://id.wikipedia.org/wiki/Mengkristal) adalah peristiwa perubahan wujud zat dari [gas](https://id.wikipedia.org/wiki/Gas) menjadi padat, zat melepaskan energi panasnya. Contohnya gas dari [kapur barus](https://id.wikipedia.org/wiki/Kapur_barus) dapat dipadatkan lagi melalui metode [kristalisasi](https://id.wikipedia.org/wiki/Kristalisasi).

### Menguap

[Menguap](https://id.wikipedia.org/wiki/Menguap) adalah peristiwa perubahan wujud zat dari cair menjadi gas, peristiwa ini memerlukan energi panas. Contohnya air yang dipanaskan lambat laun akan menguap.

### Menyublim

[Menyublim](https://id.wikipedia.org/wiki/Menyublim) adalah peristiwa perubahan zat dari padat menjadi gas, di aman zat memerlukan energi panas. Contohnya kapur barus yang disimpan di tempat terbuka lambat laun menjadi habis.

### Mengembun

[Mengembun](https://id.wikipedia.org/wiki/Mengembun) adalah peristiwa perubahan wujud zat dari gas menjadi cair, dalam peristiwa ini zat melepaskan energi panas. Contohnya uap air yang menjadi titik air, terjadinya embun pada pagi hari.
...
- Menghancurkan [kaleng](https://id.wikipedia.org/wiki/Kaleng)
- Mencairkan es batu
- Air mendidih
- Mencampur air dan pasir
- Mencampur [minyak](https://id.wikipedia.org/wiki/Minyak) dan air
- [Kaca](https://id.wikipedia.org/wiki/Kaca) pecah
- Memecahkan [gelas](https://id.wikipedia.org/wiki/Gelas)
- Memecahkan telur
- Melarutkan [gula](https://id.wikipedia.org/wiki/Gula) dan air
- [Kertas](https://id.wikipedia.org/wiki/Kertas) pencacah
- Memotong [kayu](https://id.wikipedia.org/wiki/Kayu)
- Mencampur kelereng merah dan hijau
- [Sublimasi](https://id.wikipedia.org/wiki/Sublimasi) es kering menjadi [karbon dioksida](https://id.wikipedia.org/wiki/Karbon_dioksida)
- Meremas kantong kertas
- Melelehkan [belerang](https://id.wikipedia.org/wiki/Belerang) padat menjadi cair. Ini adalah contoh yang menarik karena perubahan keadaan memang menyebabkan perubahan warna, meskipun [komposisi kimianya](https://id.wikipedia.org/wiki/Komposisi_kimia) sama sebelum dan sesudah perubahan.
- Mencampurkan gula dan air
- Mencampurkan permen merah dan biru
- Memotong [apel](https://id.wikipedia.org/wiki/Apel)
- Memecah [batu](https://id.wikipedia.org/wiki/Batu)
- Menguapkan [nitrogen cair](https://id.wikipedia.org/wiki/Nitrogen_cair)
- mencampur warna [cat](https://id.wikipedia.org/wiki/Cat)
- Membuat bentuk dari tanah liat
- Meletuskan [balon](https://id.wikipedia.org/wiki/Balon)
- Mengiriskan [roti](https://id.wikipedia.org/wiki/Roti)
## Perubahan Kimia
**Perubahan kimia** adalah perubahan yang menghasilkan suatu [zat](https://id.wikipedia.org/wiki/Zat) baru dan tidak dapat dikembalikan. Perubahan menghasilkan jenis dan sifat [materi](https://id.wikipedia.org/wiki/Materi) berbeda (baru) dari zat semula dinamakan (perubahan kimia dinamakan juga [reaksi kimia](https://id.wikipedia.org/wiki/Reaksi_kimia) atau reaksi) yang melibatkan penataan ulang [atom](https://id.wikipedia.org/wiki/Atom) dari satu atau lebih zat dan perubahan dalam sifat atau komposisinya. Perububahan kimia mengakibatkan terjadinya perubahan susunan [molekul](https://id.wikipedia.org/wiki/Molekul) kimia pada suatu benda. Dan pada umumnya, perubahan susunan kimia tersebut akan menyebabkan perubahan fisik pula.

Perubahan kimia bersifat *irreversible*, atau tidak dapat dibalik. Dalam perubahan kimia dihasilkan jenis materi yang berbeda dengan materi semula, sehingga terdapat dua istilah yang digunakan dalam reaksi kimia, yaitu zat semula dinamakan [reaktan](https://id.wikipedia.org/wiki/Reaktan) atau pereaksi, dan zat yang terbentuk dinamakan hasil reaksi atau produk reaksi. Pada pembakaran [kayu](https://id.wikipedia.org/wiki/Kayu), kayu dinamakan pereaksi dan [arang](https://id.wikipedia.org/wiki/Arang) kayu dinamakan hasil reaksi.

### Mekanisme

Perubahan kimia terjadi ketika reaksi kimia terjadi. Perubahan kimia terjadi dalam skala yang jauh lebih kecil. Mereka melibatkan pembentukan [unsur](https://id.wikipedia.org/wiki/Unsur_kimia) atau [senyawa kimia](https://id.wikipedia.org/wiki/Senyawa_kimia) baru. Meskipun beberapa percobaan menunjukkan perubahan kimia yang jelas, seperti perubahan warna, sebagian besar perubahan kimia tidak terlihat.

Agar reaksi kimia terjadi, [partikel](https://id.wikipedia.org/wiki/Partikel) harus bertabrakan satu sama lain. Namun, tidak semua tabrakan antarpartikel mengarab pada reaksi kimia.

Ini mungkin terjadi karena [reaktivitas](https://id.wikipedia.org/wiki/Reaktivitas_(kimia)) zat yang terlibat. Misalnya, [emas](https://id.wikipedia.org/wiki/Emas) tidak bereaksi dengan [oksigen](https://id.wikipedia.org/wiki/Oksigen) (karena emas sangat tidak reaktif) meskipun partikel oksigen di udara bertabrakan dengan emas di [perhiasan](https://id.wikipedia.org/wiki/Perhiasan).

Besi adalah logam yang lebih reaktif daripada emas sehingga besi bereaksi dengan oksigen. Namun, reaksi besi dengan oksigen ([pengaratan](https://id.wikipedia.org/w/index.php?title=Pengaratan&action=edit&redlink=1)) berlangsung lambat. Hal ini menunjukkan tidak semua tabrakan antara partikel besi dan oksigen menyebabkan terjadinya reaksi. Alasannya adalah bahwa tabrakan mungkin tidak terjadi dengan energi yang cukup untuk terjadinya reaksi.

### Ciri-Ciri

Perubahan kimia adalah perubahan yang menghasilkan zat baru karena mengubah [komposisi](https://id.wikipedia.org/wiki/Komposisi_kimia) atau [struktur zat](https://id.wikipedia.org/wiki/Struktur_kimia) yang diubahnya. Berbeda dengan [perubahan fisika](https://id.wikipedia.org/wiki/Perubahan_fisika) yang hanya mengubah bentuk atau fase tanpa mengubah struktur zatnya. Beberapa ciri-ciri zat kimia adalah:

- Terbentuknya zat baru hasil reaksi.
- Terdapat perubahan molekul (bukan hanya sekadar perubahan fisik)
- Perubahan [warna](https://id.wikipedia.org/wiki/Warna): suatu zat memiliki warna tertentu tergantung komposisi dan kandungan [unsur](https://id.wikipedia.org/wiki/Unsur_kimia) atau [senyawa](https://id.wikipedia.org/wiki/Senyawa_kimia) dalam zat tersebut.
- Perubahan [suhu](https://id.wikipedia.org/wiki/Suhu): reaksi kimia terjadi karena adanya perubahan [energi](https://id.wikipedia.org/wiki/Energi) yang menyertai reaksi kimia. Ada perubahan suhu yang menyertai perubahan kimia yaitu kalor yang dilepaskan dan [kalor](https://id.wikipedia.org/wiki/Kalor) yang dibutuhkan dalam perubahan kimia.
- Perubahan [bau](https://id.wikipedia.org/wiki/Bau)
- Terbentuknya [gas](https://id.wikipedia.org/wiki/Gas): beberapa perubahan kimia ada yang menghasilkan gas.
- Timbulnya [cahaya](https://id.wikipedia.org/wiki/Cahaya)
- Pembentukan [endapan](https://id.wikipedia.org/wiki/Endapan) baru: suatu zat yang sukar [larut](https://id.wikipedia.org/wiki/Larutan) dalam [pelarut](https://id.wikipedia.org/wiki/Pelarut) [air](https://id.wikipedia.org/wiki/Air).
- Perubahan [pH](https://id.wikipedia.org/wiki/PH)
- Perubahan menghasilkan zat baru yang tidak dapat dikembalikan atau *irreversible*.

Macam-macam perubahan kimia tersebut bisa terjadi karena proses [pembakaran](https://id.wikipedia.org/wiki/Pembakaran), [pembusukan](https://id.wikipedia.org/wiki/Pembusukan), [enzim](https://id.wikipedia.org/wiki/Enzim), [fermentasi](https://id.wikipedia.org/wiki/Fermentasi), dan lain sebagainya.

### Contoh-Contoh

Contoh perubahan kimia antara lain:

- Pembakaran kayu yang menghasilkan [arang](https://id.wikipedia.org/wiki/Arang) kayu
- Perubahan warna [cabai](https://id.wikipedia.org/wiki/Cabai) hijau menjadi merah
- [Perkaratan](https://id.wikipedia.org/wiki/Karat) pada [pagar](https://id.wikipedia.org/wiki/Pagar) [besi](https://id.wikipedia.org/wiki/Besi)
- [Pematangan](https://id.wikipedia.org/w/index.php?title=Pematangan&action=edit&redlink=1) buah
- [Pembusukan](https://id.wikipedia.org/wiki/Pembusukan) makanan
- [Metabolisme](https://id.wikipedia.org/wiki/Metabolisme) makanan dalam tubuh
- Pencampuran [asam](https://id.wikipedia.org/wiki/Asam) dan [basa](https://id.wikipedia.org/wiki/Basa)
- [Telur](https://id.wikipedia.org/wiki/Telur) yang dimasak
- Mencerna makanan dengan [air liur](https://id.wikipedia.org/wiki/Air_liur)
- Membuat roti ([baking soda](https://id.wikipedia.org/wiki/Baking_soda) + [cuka](https://id.wikipedia.org/wiki/Cuka))
- Memanggang [kue](https://id.wikipedia.org/wiki/Kue)
- Pelapisan pada [logam](https://id.wikipedia.org/wiki/Logam)
- [Baterai](https://id.wikipedia.org/wiki/Baterai) kimia
- [Kembang api](https://id.wikipedia.org/wiki/Kembang_api) atau [petasan](https://id.wikipedia.org/wiki/Petasan) yang meledak
- Memasak [daging](https://id.wikipedia.org/wiki/Daging)
- [Susu](https://id.wikipedia.org/wiki/Susu) menjadi asam rasanya
- [Kertas](https://id.wikipedia.org/wiki/Kertas) yang dibakar menjadi [abu](https://id.wikipedia.org/wiki/Abu)
- Makanan yang dimakan diproses di dalam tubuh menjadi feses
- Pembentukan [sel darah merah](https://id.wikipedia.org/wiki/Sel_darah_merah) di [sumsum tulang](https://id.wikipedia.org/wiki/Sumsum_tulang)
- [Penguraian sampah](https://id.wikipedia.org/w/index.php?title=Penguraian_sampah&action=edit&redlink=1)
...
Melansir dari *National Heart, Lung, and Blood Institute*, bernapas dimulai dengan dua fase, yakni menghirup dan menghembuskan.
...
[Mengapa bernapas dapat menghasilkan energi](https://www.kompas.com/tag/mengapa-bernapas-dapat-menghasilkan-energi) untuk tubuh? Melansir dari *Oxford University Museum of Natural History*, selama respirasi, oksigen bereaksi dengan glukosa (gula dari makanan) untuk menghasilkan energi dalam bentuk adenosine triphosphate (ATP).
...
- **Kelenjar keringat ekrin** tersebar di seluruh permukaan tubuh tetapi lebih banyak terdapat [telapak tangan](https://id.wikipedia.org/w/index.php?title=Telapak_tangan&action=edit&redlink=1), [telapak kaki](https://id.wikipedia.org/wiki/Telapak_kaki), dan [wajah](https://id.wikipedia.org/wiki/Wajah). Keringat yang dihasilkan adalah air yang mengandung berbagai macam garam. Kelenjar ini berfungsi sebagai pengatur suhu tubuh.
- **Kelenjar keringat apokrin** menghasilkan keringat yang mengandung lemak. Kelenjar ini terutama terdapat pada [ketiak](https://id.wikipedia.org/wiki/Ketiak) dan sekitar [alat kelamin](https://id.wikipedia.org/wiki/Alat_kelamin). Aktivitas kelenjar ini menghasilkan bau karena aktivitas [bakteri](https://id.wikipedia.org/wiki/Bakteri) yang memecah komponen organik dari keringat yang dihasilkannya. Apabila ingin mandi setelah berkeringat banyak, tunggulah sejenak sebelum mandi dan gunakanlah air hangat ketika mandi.
...
Ada beberapa jenis racun yang dibuang melalui kelenjar keringat di kulit, antara lain zat logam, [*bisphenol A*](https://www.alodokter.com/cek-apakah-botol-minum-atau-kotak-makan-plastikmu-membahayakan-kesehatan), *polychlorinated biphenyls*, urea, *phthalate,* dan bikarbonat. Tak hanya racun, kelenjar keringat di kulit juga berfungsi untuk membunuh dan membuang bakteri.
...
**Sistem peredaran darah** atau **sistem kardiovaskular** atau yang biasa disebut sistem sirkulasi adalah suatu sistem [organ](https://id.wikipedia.org/wiki/Organ_(anatomi)) yang berfungsi memindahkan zat dan nutrisi dari [sel](https://id.wikipedia.org/wiki/Sel). Sistem ini juga membantu stabilisasi suhu dan pH tubuh (bagian dari [homeostasis](https://id.wikipedia.org/wiki/Homeostasis)).

Ada dua jenis sistem peredaran darah: sistem peredaran darah terbuka, dan sistem peredaran darah tertutup. sistem peredaran darah, yang merupakan juga bagian dari kinerja [jantung](https://id.wikipedia.org/wiki/Jantung) dan jaringan pembuluh darah (sistem kardiovaskuler) dibentuk. Sistem ini menjamin kelangsungan hidup organisme, didukung oleh metabolisme setiap [sel](https://id.wikipedia.org/wiki/Sel) dalam tubuh dan mempertahankan sifat [kimia](https://id.wikipedia.org/wiki/Kimia) dan [fisiologis](https://id.wikipedia.org/wiki/Fisiologis) cairan tubuh.

1. Pertama, darah mengangkut [oksigen](https://id.wikipedia.org/wiki/Oksigen) dari paru-paru ke sel dan karbon dioksida dalam arah yang berlawanan (lihat [respirasi](https://id.wikipedia.org/wiki/Respirasi)).
...
[asam urat](https://id.wikipedia.org/wiki/Asam_urat)

) yang kemudian diangkut ke jaringan lain atau organ-organ ekskresi (

[ginjal](https://id.wikipedia.org/wiki/Ginjal)

dan usus besar). Juga mendistribusikan darah seperti

[hormon](https://id.wikipedia.org/wiki/Hormon)

, sel-sel kekebalan tubuh dan bagian-bagian dari sistem

[pembekuan](https://id.wikipedia.org/wiki/Pembekuan)
...
**Plasma darah merupakan komponen penyusun darah yang paling banyak**

. Terdiri dari mineral, protein-protein darah, antibodi, nutrisi, hormon, gas terlarut, dan zat hasil ekskresi.

![](https://cdn-web-2.ruangguru.com/landing-pages/assets/a76e8635-d3f1-4100-a1ac-16c421b8d053.png)

Sementara itu,

**sel darah dibagi lagi nih menjadi tiga komponen penyusun, yaitu sel darah merah, sel darah putih, dan keping darah**

. Ketiganya, tentu saja punya peran dan fungsi yang berbeda.
#### Sel Darah Merah
Sel darah merah berfungsi untuk

**membawa hemoglobin yang mengikat oksigen dari paru-paru menuju jaringan lain di tubuh**

. Selain itu, sel darah merah juga harus

**mengangkut hemoglobin yang mengikat karbondioksida kembali ke paru-paru**

, untuk melanjutkan siklus pernapasan manusia.
#### Sel Darah Putih (Leukosit)
Sel darah putih disebut juga dengan leukosit. Ukurannya lebih besar dari sel darah merah. Sel darah putih

**berfungsi untuk menjaga kekebalan dan pertahanan tubuh**
...
Terakhir, keping darah atau trombosit

**berfungsi untuk menggumpalkan darah**

. Tujuannya, untuk mengurangi darah yang keluar ketika terjadi luka terbuka pada manusia.
### Pembuluh Darah
...
**Jantung** ([bahasa Latin](https://id.wikipedia.org/wiki/Bahasa_Latin): *cor*) adalah sebuah rongga, rongga [organ](https://id.wikipedia.org/wiki/Organ_(anatomi)) berotot yang berfungsi sebagai pemompa [darah](https://id.wikipedia.org/wiki/Darah) lewat [pembuluh darah](https://id.wikipedia.org/wiki/Pembuluh_darah) oleh kontraksi berirama yang berulang. Darah menyuplai oksigen dan nutrisi pada tubuh, juga membantu menghilangkan sisa-sisa metabolisme. Istilah ***kardiak*** berarti **berhubungan dengan jantung**, dari kata [Yunani](https://id.wikipedia.org/wiki/Bahasa_Yunani) *cardia* untuk **jantung**. Jantung adalah salah satu organ manusia yang berperan dalam [sistem peredaran](https://id.wikipedia.org/wiki/Sistem_peredaran) darah, terletak di rongga dada agak sebelah kiri.

Pada manusia, [mamalia](https://id.wikipedia.org/wiki/Mamalia), dan [burung](https://id.wikipedia.org/wiki/Burung), jantung dibagi menjadi empat ruas: atrium atas kanan dan kiri; dan ventrikel bawah kanan dan kiri. Pada umumnya atrium dan ventrikel kanan disebut jantung kanan, dan sisanya disebut jantung kiri. [Ikan](https://id.wikipedia.org/wiki/Ikan) hanya memiliki dua ruas, sebuah atrium dan sebuah ventrikel, sementara [reptil](https://id.wikipedia.org/wiki/Reptil) memiliki tiga ruas. Pada jantung yang sehat darah mengalir satu arah melalui pembuluh darah. Terdapat sebuah kantung pembungkus yang melindungi jantung, [perikardium](https://id.wikipedia.org/wiki/Perikardium), yang juga mengandung sedikit cairan. Dinding jantung tersusun atas tiga lapisan: epikardium, [miokardium](https://id.wikipedia.org/wiki/Miokardium), dan endokardium.

Jantung memompa darah melewati dua sistem sirkulasi. Darah yang berasal dari sistem peredaran darah besar mengandung sedikit oksigen dan memasuki atrium kanan melalui [vena](https://id.wikipedia.org/wiki/Pembuluh_balik) kava superior dan inferior menuju ventrikel kanan. Dari sini darah dipompa menuju paru-paru, tempat darah memperoleh oksigen dan meninggalkan [karbon dioksida](https://id.wikipedia.org/wiki/Karbon_dioksida). Darah yang sudah mengandung oksigen kembali menuju atrium kiri, melewati ventrikel kiri dan dipompa menuju seluruh tubuh melalui [aorta](https://id.wikipedia.org/wiki/Aorta)—di mana [oksigen](https://id.wikipedia.org/wiki/Oksigen) dipakai dan melalui metabolisme menjadi karbon dioksida. Ditambah lagi, darah juga membawa nutrisi dari hati menuju berbagai organ tubuh, sementara membawa zat sisa menuju hati dan ginjal. Normalnya, jumlah darah yang terpompa menuju paru-paru sama dengan jumlah darah yang terpompa ke seluruh tubuh. Pembuluh vena memompa darah menuju jantung dan membawa darah yang kaya karbon dioksida - kecuali vena pulmonaris dan vena pada sistem pencernaan. Arteri membawa darah keluar jantung, membawa oksigen selain pada arteri pulmonaris. Jarak yang jauh dari jantung membuat pembuluh vena memiliki tekanan yang lebih kecil dari pembuluh arteri. Ketika beristirahat, jantung berdetak kurang lebih 72 kali per menit. Latihan fisik biasanya mengangkat jumlahnya, tetapi jumlah melambat selama beberapa waktu, yang baik untuk jantung.

Penyakit kardiovaskular adalah penyebab kematian yang umum pada tahun 2008, membawa 30% manusia pada kematian. Diikuti oleh penyakit pembuluh koroner dan stroke. Penyebab utamanya adalah:

[merokok](https://id.wikipedia.org/wiki/Rokok)

,

[obesitas](https://id.wikipedia.org/wiki/Obesitas)

, latihan yang kurang,

[kolesterol](https://id.wikipedia.org/wiki/Kolesterol)

tinggi,

[tekanan darah tinggi](https://id.wikipedia.org/wiki/Tekanan_darah_tinggi)

,

[diabetes](https://id.wikipedia.org/wiki/Diabetes)

, dan lain-lain. Diagnosis dari kardiovaskular sering kali dilakukan dengan

[stetoskop](https://id.wikipedia.org/wiki/Stetoskop)

, ECG atau melalui pendengaran

[ultrasonik](https://id.wikipedia.org/wiki/Ultrasonik)

. Spesial yang fokus pada penyakit jantung disebut

[kardiologis](https://id.wikipedia.org/wiki/Kardiologi)
...
Tiap serambi dan bilik pada masing-masing belahan jantung dipisahkan oleh sebuah katup. Katup di antara atrium kanan dan [bilik kanan](https://id.wikipedia.org/wiki/Ventrikel) disebut [katup trikuspidalis](https://id.wikipedia.org/w/index.php?title=Katup_trikuspidalis&action=edit&redlink=1) atau katup berdaun tiga. Sedangkan katup yang ada di antara serambi kiri dan [bilik kiri](https://id.wikipedia.org/wiki/Ventrikel) disebut [katup mitralis](https://id.wikipedia.org/w/index.php?title=Katup_mitralis&action=edit&redlink=1) atau katup bikuspidalis (katup berdaun dua).
...
**Hukum gerak Newton** adalah [hukum fisika](https://id.wikipedia.org/wiki/Hukum_fisika) yang menjelaskan [perpindahan](https://id.wikipedia.org/wiki/Perpindahan) suatu [objek](https://id.wikipedia.org/wiki/Objek) sebagai hasil hubungan antara nilai dan jarak dari [gaya](https://id.wikipedia.org/wiki/Gaya_(fisika)) yang berlaku pada objek tersebut. Hukum gerak Newton merupakan salah satu dari tiga [hukum fisika](https://id.wikipedia.org/wiki/Hukum_fisika) yang menjadi dasar [mekanika klasik](https://id.wikipedia.org/wiki/Mekanika_klasik). Hukum ini menggambarkan hubungan antara [gaya](https://id.wikipedia.org/wiki/Gaya) yang bekerja pada suatu benda dan [gerak](https://id.wikipedia.org/wiki/Gerak) yang disebabkannya. Hukum ini telah dituliskan dengan pembahasaan yang berbeda-beda selama hampir 3 abad, dan dapat dirangkum sebagai berikut:

1. **Hukum Pertama**: setiap benda akan memiliki [kecepatan](https://id.wikipedia.org/wiki/Kecepatan) yang konstan kecuali ada gaya yang resultannya tidak nol bekerja pada benda tersebut. Berarti jika [resultan gaya](https://id.wikipedia.org/w/index.php?title=Resultan_gaya&action=edit&redlink=1) nol, maka [pusat massa](https://id.wikipedia.org/wiki/Pusat_massa) dari suatu benda tetap diam, atau bergerak dengan [kecepatan](https://id.wikipedia.org/wiki/Kecepatan) konstan (tidak mengalami percepatan). Hal ini berlaku jika dilihat dari [kerangka acuan inersial](https://id.wikipedia.org/wiki/Kerangka_acuan_inersial).
2. **Hukum Kedua**: sebuah benda dengan [massa](https://id.wikipedia.org/wiki/Massa) M mengalami gaya resultan sebesar F akan mengalami [percepatan](https://id.wikipedia.org/wiki/Percepatan) a yang [arahnya](https://id.wikipedia.org/w/index.php?title=Arah&action=edit&redlink=1) sama dengan arah gaya, dan besarnya berbanding lurus terhadap F dan berbanding terbalik terhadap M. atau ∑F=ma. Bisa juga diartikan resultan gaya yang bekerja pada suatu benda sama dengan [turunan](https://id.wikipedia.org/wiki/Turunan) dari [momentum linear](https://id.wikipedia.org/wiki/Momentum) benda tersebut terhadap [waktu](https://id.wikipedia.org/wiki/Waktu).
    
    [{ =ma}](https://wikimedia.org/api/rest_v1/media/math/render/svg/311333edb85e17a819b5e54da1ef40b9513bf495)
    
3. **Hukum Ketiga**: gaya aksi dan reaksi dari dua benda memiliki besar yang sama, dengan arah terbalik, dan segaris. Artinya jika ada benda A yang memberi gaya sebesar F pada benda B, maka benda B akan memberi gaya sebesar –F kepada benda A. F dan –F memiliki besar yang sama namun arahnya berbeda. Hukum ini juga terkenal sebagai hukum aksi-reaksi, dengan F disebut sebagai [aksi](https://id.wikipedia.org/wiki/Aksi) dan –F adalah [reaksinya](https://id.wikipedia.org/w/index.php?title=Reaksinya&action=edit&redlink=1).

Ketiga hukum gerak ini pertama dirangkum oleh [Isaac Newton](https://id.wikipedia.org/wiki/Isaac_Newton) dalam karyanya [*Philosophiæ Naturalis Principia Mathematica*](https://id.wikipedia.org/wiki/Philosophi%C3%A6_Naturalis_Principia_Mathematica), pertama kali diterbitkan pada 5 Juli 1687. Newton menggunakan karyanya untuk menjelaskan dan meniliti gerak dari bermacam-macam benda fisik maupun sistem. Contohnya dalam jilid tiga dari naskah tersebut, Newton menunjukkan bahwa dengan menggabungkan antara hukum gerak dengan [hukum gravitasi umum](https://id.wikipedia.org/wiki/Hukum_gravitasi_universal_Newton), ia dapat menjelaskan [hukum pergerakan planet](https://id.wikipedia.org/wiki/Hukum_Gerak_Planet_Kepler) milik [Kepler](https://id.wikipedia.org/wiki/Kepler).

## Inersia

**Inersia**, **kelembaman**, atau **kelengaian** adalah kecenderungan semua benda fisik untuk menolak perubahan terhadap keadaan geraknya. Secara numerik, ini diwakili oleh [massa](https://id.wikipedia.org/wiki/Massa) benda tersebut. Prinsip inersia adalah salah satu dasar dari [fisika klasik](https://id.wikipedia.org/wiki/Fisika_klasik) yang digunakan untuk memberikan gerakan benda dan pengaruh gaya yang dikenakan terhadap benda itu. Kata *inersia* berasal dari kata [bahasa Latin](https://id.wikipedia.org/wiki/Bahasa_Latin), “iners”, yang berarti lembam, atau malas. [Isaac Newton](https://id.wikipedia.org/wiki/Isaac_Newton) mendefinisikan inersia sebagai:
...
Dalam pemakaian umum orang juga dapat menggunakan istilah “inersia” untuk mengacu kepada “jumlah hambatan terhadap perubahan kecepatan” (yang dikuantifikasi sebagai [massa](https://id.wikipedia.org/wiki/Massa)), atau kadang-kadang juga terhadap momentumnya, tergantung terhadap konteks. Istilah “inersia” lebih baik dipahami sebagai istilah yang lebih pendek untuk “prinsip inersia” seperti yang dideskripsikan oleh Newton dalam [hukum I Newton](https://id.wikipedia.org/wiki/Hukum_gerak_Newton). Hukum ini, dinyatakan dengan singkat, mengatakan bahwa sebuah benda yang tidak dikenakan oleh gaya luar (gaya netto sama dengan nol) bergerak dengan kecepatan tetap. Dalam kata-kata yang lebih sederhana, suatu benda akan terus bergerak pada kecepatannya saat ini tanpa berubah arah, hingga ada gaya yang menyebabkannya mengubah kecepatan atau arahnya. Ini juga termasuk benda yang tidak bergerak (kecepatan = nol), yang akan tetap dalam keadaan diam sampai ada gaya yang menyebabkannya bergerak.
...
Contoh dari energi mekanik dalam permainan badminton adalah kegiatan *service.* Mulai dari pemain memukul bola (mengeluarkan energi kinetik), lalu *shuttlecock* terbang melambung (energi potensial), sampai kok jatuh ke lapangan lawan.
...
## Energi Kinetik
Di [fisika](https://id.wikipedia.org/wiki/Fisika), **energi kinetik** atau **tenaga gerak** adalah [energi](https://id.wikipedia.org/wiki/Energi) yang dimiliki oleh sebuah benda oleh karena kecepatannya ([gerakannya](https://id.wikipedia.org/wiki/Gerak)).

Di

[mekanika klasik](https://id.wikipedia.org/wiki/Mekanika_klasik)

, kinetik energi dari objek tidak berputar dengan

[massa](https://id.wikipedia.org/wiki/Massa)

*m*

yang berjalan dengan kecepatan

*v*

bernilai 12mv2

[{mv^{2}}](https://wikimedia.org/api/rest_v1/media/math/render/svg/689701aed83c55c0c88edc47453833d1abeab74e)

.

Energi kinetik dari suatu benda bernilai sama dengan [usaha](https://id.wikipedia.org/wiki/Usaha_(fisika)) ([gaya](https://id.wikipedia.org/wiki/Gaya_(fisika)) dikali dengan [perpindahan](https://id.wikipedia.org/wiki/Perpindahan)) yang dibutuhkan untuk mencapai [kecepatan](https://id.wikipedia.org/wiki/Kecepatan) yang dibutuhkan. Setelah mendapatkan energi dari [akselerasi](https://id.wikipedia.org/wiki/Akselerasi), massa menyimpan kinetik energi ini kecuali kecepatannya berubah. Usaha yang sama dikeluarkan oleh benda tersebut ketika berdeselerasi dari kecepatannya hingga ke dalam posisi [diam](https://id.wikipedia.org/wiki/Inersia).

[Satuan internasional](https://id.wikipedia.org/wiki/Sistem_satuan_internasional) dari energi kinetik adalah [joule](https://id.wikipedia.org/wiki/Joule), sementara [satuan Inggris](https://id.wikipedia.org/w/index.php?title=Satuan_Teknik_Inggris&action=edit&redlink=1) dari energi kinetik adalah [pon-kaki](https://id.wikipedia.org/w/index.php?title=Pon-kaki&action=edit&redlink=1).

Di

[mekanika relativitas](https://id.wikipedia.org/wiki/Relativitas_khusus)
...
[memperkirakan](https://id.wikipedia.org/wiki/Penghampiran)

energi kinetik hanyak ketika kecepatan

*v*

bernilai jauh di bawah

[kecepatan cahaya](https://id.wikipedia.org/wiki/Kecepatan_cahaya)
...
adalah energi yang mempengaruhi benda karena posisi (

[ketinggian](https://id.wikipedia.org/wiki/Ketinggian)

) benda tersebut yang mana kecenderungan tersebut menuju tak terhingga dengan arah dari

[gaya](https://id.wikipedia.org/wiki/Gaya)

yang ditimbulkan dari energi potensial tersebut.

[Satuan SI](https://id.wikipedia.org/wiki/Sistem_Satuan_Internasional)

untuk mengukur usaha dan energi adalah

[Joule](https://id.wikipedia.org/wiki/Joule)

(simbol J). Energi potensial juga bisa dimiliki oleh benda dalam keadaan tertekan seperti panah yang akan dilepaskan dari busurnya.

Sebutan “energi potensial” pertama kali dikemukakan oleh seorang teknik dan fisikawan berkebangsaan Skotlandia, [William Rankine](https://id.wikipedia.org/w/index.php?title=William_Rankine&action=edit&redlink=1).
...
Fungsi Utama Rongga Hidung dan Strukturnya Artikel Kesehatan
...
Fungsi Rongga Hidung: Pernapasan dan Penghidu
...
## Massa
**Massa** (dari [bahasa Yunani](https://id.wikipedia.org/wiki/Bahasa_Yunani) μάζα) atau **jisim** adalah suatu sifat [fisika](https://id.wikipedia.org/wiki/Fisika) dari suatu benda yang digunakan untuk menjelaskan berbagai perilaku objek yang terpantau.

Dalam kegunaan sehari-hari, massa biasanya disinonimkan dengan [berat](https://id.wikipedia.org/wiki/Berat) (misalnya untuk berat badan, alih-alih massa badan). Namun menurut pemahaman ilmiah modern, [berat](https://id.wikipedia.org/wiki/Berat) suatu objek diakibatkan oleh interaksi massa dengan [medan gravitasi](https://id.wikipedia.org/wiki/Medan_gravitasi).
...
Konsep modern massa diperkenalkan oleh [Sir Isaac Newton](https://id.wikipedia.org/wiki/Isaac_Newton) ([1642](https://id.wikipedia.org/wiki/1642)-[1727](https://id.wikipedia.org/wiki/1727)) dalam penjelasan gravitasi dan inersia yang dikembangkannya. Sebelumnya, berbagai fenomena gravitasi dan inersia dipandang sebagai dua hal yang berbeda dan tidak berhubungan. Namun, Isaac Newton menggabungkan fenomena-fenomena ini dan berargumen bahwa kesemuaan fenomena ini disebabkan oleh adanya keberadaan massa.

## Volume

**Volume** atau **isi padu** adalah penghitungan seberapa banyak ruang yang bisa ditempati dalam suatu objek. Objek itu bisa berupa benda yang beraturan ataupun benda yang tidak beraturan. Benda yang beraturan misalnya [kubus](https://id.wikipedia.org/wiki/Kubus), [balok](https://id.wikipedia.org/wiki/Balok), [tabung](https://id.wikipedia.org/wiki/Silinder), [limas](https://id.wikipedia.org/wiki/Limas), [kerucut](https://id.wikipedia.org/wiki/Kerucut), dan [bola](https://id.wikipedia.org/wiki/Bola_(geometri)). Benda yang tidak beraturan misalnya batu yang ditemukan di jalan. Volume digunakan untuk menentukan [massa jenis](https://id.wikipedia.org/wiki/Massa_jenis) suatu benda.
...
Dilansir dari *Chemistry LibreTexts*, satuan internasional untuk volume adalah meter kubik (m³), tetapi volume yang lebih kecil dapat diukur menggunakan satuan sentimeter kubik (cm³).
...
Dilansir dari *Sciencing*, massa adalah kuantitas yang konstan dan tidak berubah di mana pun zat atau benda tersebut berada.
...
**Kondensasi** atau **pengembunan** adalah perubahan [wujud benda](https://id.wikipedia.org/wiki/Fase_benda) ke wujud yang lebih padat, seperti [gas](https://id.wikipedia.org/wiki/Gas) (atau uap) menjadi [cairan](https://id.wikipedia.org/wiki/Cairan). Kondensasi terjadi ketika uap didinginkan menjadi cairan, tetapi dapat juga terjadi bila sebuah uap dikompresi (yaitu, [tekanan](https://id.wikipedia.org/wiki/Tekanan) ditingkatkan) menjadi cairan, atau mengalami kombinasi dari pendinginan dan kompresi. Cairan yang telah terkondensasi dari uap disebut **kondensat**. Sebuah alat yang digunakan untuk mengkondensasi uap menjadi cairan disebut [kondenser](https://id.wikipedia.org/w/index.php?title=Kondenser&action=edit&redlink=1). Kondenser umumnya adalah sebuah pendingin atau [penukar panas](https://id.wikipedia.org/wiki/Penukar_panas) yang digunakan untuk berbagai tujuan, memiliki rancangan yang bervariasi, dan banyak ukurannya dari yang dapat digenggam sampai yang sangat besar.

Kondensasi uap menjadi cairan adalah lawan dari [penguapan](https://id.wikipedia.org/wiki/Penguapan) (evaporasi) dan merupakan proses [eksothermik](https://id.wikipedia.org/w/index.php?title=Eksothermik&action=edit&redlink=1) (melepas panas). Air yang terlihat di luar gelas air yang dingin pada hari yang panas adalah kondensasi.
# 21. Pengertian Listrik

**Listrik** adalah rangkaian fenomena [fisika](https://id.wikipedia.org/wiki/Fisika) yang berhubungan dengan kehadiran dan aliran [muatan listrik](https://id.wikipedia.org/wiki/Muatan_listrik). Listrik menimbulkan berbagai macam efek yang telah umum diketahui, seperti [petir](https://id.wikipedia.org/wiki/Petir), [listrik statis](https://id.wikipedia.org/wiki/Listrik_statis), [induksi elektromagnetik](https://id.wikipedia.org/wiki/Induksi_elektromagnetik) dan [arus listrik](https://id.wikipedia.org/wiki/Arus_listrik). Adanya listrik juga bisa menimbulkan dan menerima [radiasi elektromagnetik](https://id.wikipedia.org/wiki/Radiasi_elektromagnetik) seperti [gelombang radio](https://id.wikipedia.org/wiki/Gelombang_radio).

**Muatan listrik** adalah [muatan dasar](https://id.wikipedia.org/wiki/Muatan_listrik_partikel) yang dimiliki oleh [partikel](https://id.wikipedia.org/wiki/Partikel) penyusun [atom](https://id.wikipedia.org/wiki/Atom), kecuali [neutron](https://id.wikipedia.org/wiki/Neutron). Karakteristik muatan dasar hanya dimiliki oleh [proton](https://id.wikipedia.org/wiki/Proton) dan [elektron](https://id.wikipedia.org/wiki/Elektron). Muatan listrik hanya dibedakan menjadi muatan positif dan muatan negatif, serta muatan netral yang tersusun dari gabungan muatan positif dan muatan negatif dalam jumlah yang sama. Selain itu, muatan hanya ditemui pada sistem tertutup yang tidak sama dengan [massa](https://id.wikipedia.org/wiki/Massa) dan tidak teramati secara [empiris](https://id.wikipedia.org/wiki/Bukti_empiris). [Keadaan dasar](https://id.wikipedia.org/wiki/Keadaan_dasar) dari muatan adalah selalu memiliki [kuantisasi](https://id.wikipedia.org/wiki/Kuantisasi_(fisika)) berupa kelipatan [bilangan bulat](https://id.wikipedia.org/wiki/Bilangan_bulat) dengan nilai 1,602 × 10 [C](https://id.wikipedia.org/wiki/Coulomb) atau 4,77 ×10 satuan [elektrostatik](https://id.wikipedia.org/wiki/Elektrostatika). Interaksi antarmuatan listrik akan terjadi jika benda-benda yang bermuatan didekatkan satu sama lain. Gaya tolak-menolak terjadi pada benda-benda yang bermuatan sejenis,sedangkan gaya tarik-menarik akan terjadi pada benda-benda yang bermuatan tidak sejenis. [Konsep](https://id.wikipedia.org/wiki/Konsep) mengenai muatan listrik dijadikan sebagai prinsip dasar untuk menjelaskan tentang [fenomena](https://id.wikipedia.org/wiki/Fenomena) [listrik](https://id.wikipedia.org/wiki/Listrik).

Dalam listrik, muatan menghasilkan [medan elektromagnetik](https://id.wikipedia.org/wiki/Medan_elektromagnetik) yang dilakukan ke muatan lainnya. Listrik muncul akibat adanya beberapa tipe fisika:

- [muatan listrik](https://id.wikipedia.org/wiki/Muatan_listrik): sifat beberapa [partikel subatomik](https://id.wikipedia.org/wiki/Partikel_subatomik) yang menentukan [interaksi elektromagnetik](https://id.wikipedia.org/wiki/Interaksi_elektromagnetik). Substansi yang bermuatan listrik menghasilkan dan dipengaruhi oleh medan elektromagnetik
- [medan listrik](https://id.wikipedia.org/wiki/Medan_listrik) (lihat [elektrostatis](https://id.wikipedia.org/wiki/Elektrostatis)): tipe medan elektromagnetik sederhana yang dihasilkan oleh muatan listrik ketika diam (maka tidak ada [arus listrik](https://id.wikipedia.org/wiki/Arus_listrik)). Medan listrik menghasilkan gaya ke muatan lainnya
- [potensial listrik](https://id.wikipedia.org/wiki/Potensial_listrik): kapasitas medan listrik untuk melakukan [kerja](https://id.wikipedia.org/wiki/Kerja_(mekanik)) pada sebuah [muatan listrik](https://id.wikipedia.org/wiki/Muatan_listrik), biasanya diukur dalam [volt](https://id.wikipedia.org/wiki/Volt)
- [arus listrik](https://id.wikipedia.org/wiki/Arus_listrik): perpindahan atau aliran partikel bermuatan listrik, biasanya diukur dalam [ampere](https://id.wikipedia.org/wiki/Ampere)
- [elektromagnet](https://id.wikipedia.org/wiki/Elektromagnet): Muatan berpindah menghasilkan [medan magnet](https://id.wikipedia.org/wiki/Medan_magnet). Arus listrik menghasilkan medan magnet dan perubahan medan magnet menghasilkan arus listrik

Pada [teknik elektro](https://id.wikipedia.org/wiki/Teknik_elektro), listrik digunakan untuk:

- [tenaga listrik](https://id.wikipedia.org/wiki/Energi_listrik) yang digunakan untuk menghidupkan peralatan
- [elektronik](https://id.wikipedia.org/wiki/Elektronik) yang berhubungan dengan [sirkuit listrik](https://id.wikipedia.org/wiki/Sirkuit_listrik) yang melibatkan [komponen listrik aktif](https://id.wikipedia.org/wiki/Komponen_aktif) seperti [tabung vakum](https://id.wikipedia.org/wiki/Tabung_vakum), [transistor](https://id.wikipedia.org/wiki/Transistor), [dioda](https://id.wikipedia.org/wiki/Dioda) dan [sirkuit terintegrasi](https://id.wikipedia.org/wiki/Sirkuit_terintegrasi)

Fenomena listrik telah dipelajari sejak zaman purba, meskipun pemahaman secara teoritisnya berkembang lamban hingga abad ke-17 dan 18. Meski begitu, aplikasi praktisnya saat itu masih sedikit, hingga di akhir abad ke-19 para [insinyur](https://id.wikipedia.org/wiki/Teknik_elektro) dapat memanfaatkannya pada industri dan rumah tangga. Perkembangan yang luar biasa cepat pada teknologi listrik mengubah industri dan masyarakat. Fleksibilitas listrik yang amat beragam menjadikan penggunaannya yang hampir tak terbatas seperti [transportasi](https://id.wikipedia.org/wiki/Tenaga_gerak), [pemanasan](https://id.wikipedia.org/wiki/HVAC), [penerangan](https://id.wikipedia.org/wiki/Penerangan_listrik), [telekomunikasi](https://id.wikipedia.org/wiki/Telekomunikasi), dan [komputasi](https://id.wikipedia.org/wiki/Komputasi). Tenaga listrik saat ini adalah tulang punggung masyarakat industri modern.

# 22. Sifat Listrik

### Pembentukan

Setiap [benda](https://id.wikipedia.org/wiki/Benda) memiliki atom dengan bagian berupa proton, elektron dan neutron. Pembentukan muatan listrik pada suatu benda merupakan akibat dari susunan proton dan elektron dalam jumlah tertentu pada partikelnya. Sesuai dengan teori atom [model Thomson](https://id.wikipedia.org/wiki/Model_puding_prem), [model Rutherford](https://id.wikipedia.org/wiki/Model_Rutherford) dan [model Bohr](https://id.wikipedia.org/wiki/Model_Bohr), atom terdiri dari muatan positif di [inti atom](https://id.wikipedia.org/wiki/Inti_atom) dan muatan negatif di luar inti atom. Di dalam inti atom, terdapat proton yang dijadikan sebagai muatan positif. Percobaan muatan listrik yang dilakukan oleh Milikan memperoleh muatan terkecil dengan nilai sebesar 1,6 ×10 Coulomb. Pembentukan muatan hanya terjadi jika jumlah proton dan elektron tidak sama. Jika proton dan elektron dalam jumlah yang sama, maka benda dikatakan bermuatan netral. Benda dikatakan bermuatan negatif jika jumlah elektron lebih besar dibandingkan proton. Sedangkan benda dikatakan bermuatan positif jika jumlah proton lebih besar dibandingkan elektron. Proses pembentukan muatan listrik terjadi ketika atom melakukan [ionisasi](https://id.wikipedia.org/wiki/Ionisasi) dengan cara melepas atau menangkap elektron.

Muatan listrik pada suatu benda dapat diperoleh melalui 3 cara, yaitu memberikan [efek tribolistrik](https://id.wikipedia.org/wiki/Efek_tribolistrik), [konduksi](https://id.wikipedia.org/wiki/Konduksi) atau [induksi](https://id.wikipedia.org/wiki/Pembuktian_melalui_induksi). Efek tribolistrik diperoleh dengan menggosokkan benda yang tidak bermuatan ke benda yang bermuatan. Konduksi dilakukan dengan menghubungkan benda bermuatan dengan benda yang tidak bermuatan, sedangkan induksi dilakukan dengan mendekatkan benda yang tidak bermuatan ke benda yang bermuatan.

### Massa

Massa dari muatan listrik berbeda dengan massa pada [gaya gravitasi](https://id.wikipedia.org/wiki/Gravitasi). Massa pada gaya gravitasi hanya terdiri dari massa positif, sedangkan pada muatan listrik, massa terbagi menjadi massa positif dan massa negatif. Keberadaan dua jenis massa menyebabkan muatan listrik dapat melakukan gaya tarik dan gaya tolak. Ini berbeda dengan gaya gravitasi yang hanya mampu melakukan gaya tarik karena hanya meiliki satu jenis massa.

### Gaya tarik-menarik

Sifat dari gaya tarik suatu muatan listrik diketahui setelah [Charles Coulomb](https://id.wikipedia.org/wiki/Charles_Coulomb) melakukan [eksperimen](https://id.wikipedia.org/wiki/Percobaan) pada tahun 1736-1806. Coulomb menguji dan menentukan besar gaya tarik antara dua buah muatan listrik. Dari hasil eksperimen, diperoleh tiga kesimpulan. Pertama, jika dua buah muatan listrik dengan sifat yang berbeda (negatif dan positif) saling didekatkan, maka akan terjadi gaya tarik-menarik antara kedua muatan tersebut. Sebaliknya, jika kedua muatan memiiliki sifat yang sejenis (positif-positif atau negatif-negatif), maka kedua muatan akan saling tolak-menolak. Kedua, besar gaya tarik antara kedua buah muatan selalu berbanding terbalik dengan jarak antara kedua buah muatan tersebut. Ketiga, ukuran fisik dari muatan listrik menentukan besar gaya tarik antara kedua buah muatan listrik. Sifat gaya tarik ini dikenal dan dijelaskan secara rinci dalam rumusan-rumusan dari [hukum Coulomb](https://id.wikipedia.org/wiki/Hukum_Coulomb).

### Gaya elektrostatik

Muatan listrik memiliki gaya [elektrostatik](https://id.wikipedia.org/wiki/Elektrostatika) antara dua [muatan listrik partikel](https://id.wikipedia.org/wiki/Muatan_listrik_partikel) dengan nilai 10 kali lebih besar dibandingkan dengan gaya gravitasi antara keduanya. Faktor penyebab besarnya gaya elektrostatik pada muatan listrik belum diketahui secara pasti. Namun, [Arthur Eddington](https://id.wikipedia.org/wiki/Arthur_Eddington) dan [Paul A.M. Dirac](https://id.wikipedia.org/wiki/Paul_A.M._Dirac) memberikan perkiraan bahwa fakor gaya elektrostatik pada muatan listrik sarna dengan [akar kuadrat](https://id.wikipedia.org/wiki/Akar_kuadrat) dari jumlah materi yang ada di [alam semesta](https://id.wikipedia.org/wiki/Alam_semesta). Gaya yang terjadi antara dua buah muatan listrik memiliki arah yang tetap, yaitu pada garis [medan listrik](https://id.wikipedia.org/wiki/Medan_listrik) penghubung di antara kedua muatan. Penetapan arah muatan listrik didasarkan kepada pengertian [ruang](https://id.wikipedia.org/wiki/Ruang_vektor) yang [isotropi](https://id.wikipedia.org/wiki/Isotropi).
...
1. Apabila suatu benda memiliki jumlah elektron yang lebih banyak, maka benda tersebut akan bermuatan negatif (Σ elektron > Σ proton).
2. Apabila suatu benda memiliki jumlah elektron yang lebih sedikit, maka benda tersebut dikategorikan ke dalam benda bermuatan positif (Σ elektron < Σ proton).
3. Apabila suatu benda memiliki jumlah proton yang lebih banyak, maka benda tersebut termasuk benda bermuatan positif (Σ proton > Σ elektron).
4. Apabila suatu benda memiliki jumlah proton yang lebih sedikit, maka benda tersebut bermuatan negatif (Σ proton < Σ elektron).
5. Apabila jumlah elektron dan jumlah proton sama, maka muatan benda tersebut adalah muatan netral (Σ elektron = Σ proton).
...
adalah gaya listrik yang mempengaruhi ruang di sekeliling

[muatan listrik](https://id.wikipedia.org/wiki/Muatan_listrik)

. Penyebab timbulnya medan listrik adalah keberadaan muatan listrik yang berjenis positif dan negatif. Medan listrik dapat digambarkan sebagai garis gaya atau garis medan. Medan listrik memiliki satuan

[N](https://id.wikipedia.org/wiki/Newton)

/

[C](https://id.wikipedia.org/wiki/Coulomb)

atau dibaca

[Newton](https://id.wikipedia.org/wiki/Newton)

/

[coulomb](https://id.wikipedia.org/wiki/Coulomb)
...
yang telah memanfaatkan medan listrik ini dalam kawat konduktor (

[kabel](https://id.wikipedia.org/wiki/Kabel)
...
muatan positif dan negatif medan listrik
...
Untuk menentukan nilainya, kita bisa pakai rumus kuat medan listrik yang satu ini, *guys*.

[](https://latex.codecogs.com/gif.latex?E&space;=&space;\frac%7BkQ%7D%7Br%5E2%7D)
...
[](https://latex.codecogs.com/gif.latex?E&space;=&space;\frac%7BF%7D%7Bq%7D)
...
![rumus hukum ohm](https://ghost-blog-assets.zenius.net/wordpress/2021/04/rumus-hukum-ohm.png)
...
# 29. Resistor
**Resistor** atau **penghambat** merupakan [komponen elektronik](https://id.wikipedia.org/wiki/Komponen_elektronik) yang memiliki dua pin dan dirancang untuk mengatur [tegangan listrik](https://id.wikipedia.org/wiki/Tegangan_listrik) dan [arus listrik](https://id.wikipedia.org/wiki/Arus_listrik). Resistor mempunyai nilai resistansi (tahanan) tertentu yang dapat memproduksi [tegangan listrik](https://id.wikipedia.org/wiki/Tegangan_listrik) di antara kedua pin di mana nilai tegangan terhadap resistansi tersebut berbanding lurus dengan arus yang mengalir, berdasarkan persamaan [hukum Ohm](https://id.wikipedia.org/wiki/Hukum_Ohm):

V=IRI=VR

[{}](https://wikimedia.org/api/rest_v1/media/math/render/svg/acb62c8e40b2d83f3cc34a7416945f6b24183b2b)

Resistor digunakan sebagai bagian dari [rangkaian elektronik](https://id.wikipedia.org/wiki/Sirkuit_elektronik) dan merupakan salah satu komponen yang paling sering digunakan. Resistor dapat dibuat dari bermacam-macam komponen dan film, bahkan kawat resistansi (kawat yang dibuat dari paduan resistivitas tinggi seperti [nikel](https://id.wikipedia.org/wiki/Nikel)-[kromium](https://id.wikipedia.org/wiki/Kromium)).

Karakteristik utama dari resistor adalah [resistansinya](https://id.wikipedia.org/wiki/Resistansi) dan [daya listrik](https://id.wikipedia.org/wiki/Daya_listrik) yang dapat dihantarkan. Karakteristik lain termasuk [koefisien suhu](https://id.wikipedia.org/w/index.php?title=Koefisien_suhu&action=edit&redlink=1), [derau listrik](https://id.wikipedia.org/wiki/Derau) (*noise*), dan [induktansi](https://id.wikipedia.org/wiki/Induktansi).

Resistor dapat dipadukan ke dalam rangkaian kacukan (*hybrid circuit*) dan [papan sirkuit cetak](https://id.wikipedia.org/wiki/Papan_sirkuit_cetak) (PCB), bahkan [rangkaian terpadu](https://id.wikipedia.org/wiki/Sirkuit_terpadu) (IC). Ukuran dan letak kaki bergantung pada rancangan rangkaian, kebutuhan daya resistor harus cukup dan disesuaikan dengan kebutuhan arus rangkaian agar tidak terbakar.
# 30. GGL Induksi
...
**Unsur kimia** bisa berarti dua hal. Kesatu, unsur sama artinya dengan [atom](https://id.wikipedia.org/wiki/Atom) (misal mengatakan ‘unsur oksigen’ sama dengan mengatakan ‘atom oksigen’). Kedua, unsur berarti [zat](https://id.wikipedia.org/wiki/Zat) yaitu kumpulan sangat banyak atom hingga sampai pada tingkat yang bisa kita rasakan, bisa dilihat, dicium, dan berdampak pada tubuh (makhluk hidup, benda padat, cair, dan gas). Unsur jika lebih dirinci termasuk sebagai [zat murni](https://id.wikipedia.org/w/index.php?title=Zat_murni&action=edit&redlink=1) bersama dengan [senyawa](https://id.wikipedia.org/wiki/Senyawa).

Unsur (dalam hal ini atom) mempunyai jumlah [proton](https://id.wikipedia.org/wiki/Proton) yang sama dalam [inti atomnya](https://id.wikipedia.org/wiki/Inti_atom) (yaitu [nomor atom](https://id.wikipedia.org/wiki/Nomor_atom), atau *Z* yang sama). Sebanyak 118 unsur telah diketahui, yang mana 94 di antaranya ada secara alami di bumi. Sedangkan 24 sisanya, merupakan [unsur buatan](https://id.wikipedia.org/wiki/Unsur_sintetis). Terdapat 80 unsur yang memiliki sekurang-kurangnya satu [isotop](https://id.wikipedia.org/wiki/Isotop) stabil dan 38 unsur yang merupakan [radionuklida](https://id.wikipedia.org/wiki/Radionuklida) yang seiring berjalannya waktu [meluruh](https://id.wikipedia.org/wiki/Peluruhan_radioaktif) menjadi unsur lain. [Besi](https://id.wikipedia.org/wiki/Besi) adalah unsur penyusun bumi paling melimpah (berdasarkan [massa](https://id.wikipedia.org/wiki/Massa)), sementara di kerak bumi [oksigen](https://id.wikipedia.org/wiki/Oksigen) adalah yang paling melimpah.

Unsur kimia menyusun [materi](https://id.wikipedia.org/wiki/Materi) [biasa](https://id.wikipedia.org/wiki/Baryon) di jagat raya. Namun, [observasi astronomi](https://id.wikipedia.org/wiki/Astronomi_observasional) menyarankan bahwa materi biasa yang teramati hanya menyusun 4% dari materi di alam semesta: sisanya adalah [materi gelap](https://id.wikipedia.org/wiki/Materi_gelap) (73%); komposisinya tidak diketahui, tetapi tidak tersusun dari **unsur kimia**. Energi misterius ini kemungkinan mempercepat [inflasi](https://id.wikipedia.org/wiki/Inflasi_(kosmologi)) Alam semesta.

Dua unsur yang paling ringan, [hidrogen](https://id.wikipedia.org/wiki/Hidrogen) dan [helium](https://id.wikipedia.org/wiki/Helium), sebagian besar terbentuk dalam [Ledakan Dahsyat](https://id.wikipedia.org/wiki/Ledakan_Dahsyat) dan merupakan unsur paling umum di jagat raya. Tiga unsur berikutnya ([litium](https://id.wikipedia.org/wiki/Litium), [berilium](https://id.wikipedia.org/wiki/Berilium), dan [boron](https://id.wikipedia.org/wiki/Boron)) sebagian besar terbentuk melalui [spalasi sinar kosmis](https://id.wikipedia.org/wiki/Spalasi_sinar_kosmis), dan oleh sebab itu lebih jarang daripada unsur-unsur yang lebih berat. Pembentukan unsur dengan proton antara 6 sampai 26 terjadi dan terus berlanjut dalam bintang-bintang [deret utama](https://id.wikipedia.org/wiki/Deret_utama) melalui [nukleosintesis bintang](https://id.wikipedia.org/wiki/Nukleosintesis_bintang)[.](https://en.wikipedia.org/wiki/Stellar_nucleosynthesis) Kelimpahan oksigen, [silikon](https://id.wikipedia.org/wiki/Silikon), dan besi yang tinggi di Bumi mencerminkan produksinya yang banyak di bintang-bintang tersebut. Unsur-unsur dengan proton lebih dari 26 terbentuk melalui [nukleosintesis supernova](https://id.wikipedia.org/w/index.php?title=Nukleosintesis_supernova&action=edit&redlink=1) dalam [supernova](https://id.wikipedia.org/wiki/Supernova)[,](https://en.wikipedia.org/wiki/Supernova_nucleosynthesis) yang, ketika mereka meledak, memercikkan unsur-unsur ini sebagai [sisa-sisa supernova](https://id.wikipedia.org/wiki/Sisa-sisa_supernova) jauh ke angkasa, yang menyatu dengan [planet](https://id.wikipedia.org/wiki/Planet) ketika mereka terbentuk.

Istilah “unsur” (atau “elemen”) digunakan untuk atom-atom dengan jumlah proton tertentu (tanpa menghiraukan apakah mereka [terionisasi](https://id.wikipedia.org/wiki/Ionisasi) atau berikatan kimia, misalnya hidrogen dalam [air](https://id.wikipedia.org/wiki/Air)) maupun sebagai [zat kimia](https://id.wikipedia.org/wiki/Zat_kimia) murni yang mengandung unsur tunggal (misalnya gas hidrogen). Untuk makna yang kedua, telah diusulkan juga istilah “zat elementer” dan “zat sederhana”, tetapi tidak mendapat penerimaan yang luas dalam literatur kimia [Inggris](https://id.wikipedia.org/wiki/Bahasa_Inggris), sementara dalam beberapa bahasa lainnya kesetaraannya banyak digunakan (misalnya [bahasa Prancis](https://id.wikipedia.org/wiki/Bahasa_Prancis): *corps simple*, [bahasa Rusia](https://id.wikipedia.org/wiki/Bahasa_Rusia): простое вещество). Sebuah unsur tunggal dapat membentuk banyak zat yang berbeda strukturnya; mereka disebut [alotrop](https://id.wikipedia.org/wiki/Alotropi) unsur.Ketika unsur yang berbeda bergabung secara kimia, dengan atom-atom yang terikat melalui [ikatan kimia](https://id.wikipedia.org/wiki/Ikatan_kimia), mereka membentuk [senyawa kimia](https://id.wikipedia.org/wiki/Senyawa_kimia). Hanya sedikit unsur yang ditemukan tak berikatan sebagai [mineral](https://id.wikipedia.org/wiki/Mineral) murni. Unsur alami semacam ini di antaranya adalah [tembaga](https://id.wikipedia.org/wiki/Tembaga), [perak](https://id.wikipedia.org/wiki/Perak), [emas](https://id.wikipedia.org/wiki/Emas), [karbon](https://id.wikipedia.org/wiki/Karbon) (sebagai [batu bara](https://id.wikipedia.org/wiki/Batu_bara), [grafit](https://id.wikipedia.org/wiki/Grafit), atau [intan](https://id.wikipedia.org/wiki/Intan)), dan [belerang](https://id.wikipedia.org/wiki/Belerang). Semua unsur, kecuali yang sangat inert seperti [gas mulia](https://id.wikipedia.org/wiki/Gas_mulia) dan [logam mulia](https://id.wikipedia.org/wiki/Logam_mulia), biasanya ditemukan di bumi dalam bentuk gabungan kimianya, sebagai senyawa kimia. Sementara sekitar 32 unsur kimia yang ada di bumi dalam bentuk alami tak tergabung, sebagian besar berada sebagai campuran. Misalnya, [udara](https://id.wikipedia.org/wiki/Udara) atmosfer campuran utamanya adalah [nitrogen](https://id.wikipedia.org/wiki/Nitrogen), oksigen, dan [argon](https://id.wikipedia.org/wiki/Argon), sementara unsur padat alami terjadi dalam [logam paduan](https://id.wikipedia.org/wiki/Logam_paduan), seperti pada besi dan [nikel](https://id.wikipedia.org/wiki/Nikel).

Sejarah penemuan dan penggunaan unsur dimulai sejak [masyarakat manusia](https://id.wikipedia.org/wiki/Masyarakat) [primitif](https://id.wikipedia.org/wiki/Primitif) yang menemukan unsur-unsur alami seperti karbon, belerang, tembaga dan emas. Peradaban selanjutnya mengekstraksi unsur tembaga, timah, timbal dan besi dari [bijihnya](https://id.wikipedia.org/wiki/Bijih) melalui [peleburan](https://id.wikipedia.org/wiki/Peleburan_(metalurgi)), menggunakan [batu bara](https://id.wikipedia.org/wiki/Batu_bara). [Alkimiawan](https://id.wikipedia.org/wiki/Alkimia) dan [kimiawan](https://id.wikipedia.org/wiki/Kimiawan) secara berurutan mengidentifikasi lebih banyak lagi; seluruh unsur yang terbentuk secara alami telah diketahui pada tahun 1950.Sifat unsur kimia dirangkum dalam [tabel periodik](https://id.wikipedia.org/wiki/Tabel_periodik), yang menyusun unsur-unsur menurut kenaikan nomor atom dalam baris ([“periode”](https://id.wikipedia.org/wiki/Periode_tabel_periodik)) yang merupakan pengulangan (“secara periodik”) [sifat-sifat kimia](https://id.wikipedia.org/wiki/Sifat_kimia) dan [fisika](https://id.wikipedia.org/wiki/Sifat_fisik) kolom-kolomnya ([“golongan”](https://id.wikipedia.org/wiki/Golongan_tabel_periodik)). Selain unsur radioaktif tak stabil dengan [waktu paruh](https://id.wikipedia.org/wiki/Waktu_paruh) singkat, seluruh unsur tersedia secara [industri](https://id.wikipedia.org/wiki/Industri), sebagian besar [berketakmurnian](https://id.wikipedia.org/w/index.php?title=Ketakmurnian&action=edit&redlink=1) rendah.
## Senyawa
**Senyawa kimia** atau **senyawaan kimia** adalah [zat kimia](https://id.wikipedia.org/wiki/Zat_kimia) murni atau [zat murni](https://id.wikipedia.org/w/index.php?title=Zat_murni&action=edit&redlink=1) yang terdiri dari dua atau lebih [unsur](https://id.wikipedia.org/wiki/Unsur) atau [atom](https://id.wikipedia.org/wiki/Atom) yang berbeda jenis (misal senyawa [H2O](https://id.wikipedia.org/wiki/H2O) terdiri dari [hidrogen](https://id.wikipedia.org/wiki/Hidrogen) dan [oksigen](https://id.wikipedia.org/wiki/Oksigen), senyawa [NaCl](https://id.wikipedia.org/wiki/NaCl) terdiri dari [natrium](https://id.wikipedia.org/wiki/Natrium) dan [klorin](https://id.wikipedia.org/wiki/Klorin), dan senyawa [C12H22O11](https://id.wikipedia.org/wiki/Gula) terdiri dari [karbon](https://id.wikipedia.org/wiki/Karbon), hidrogen, dan oksigen) yang dapat dipecah-pecah lagi menjadi unsur-unsur penyusunnya itu melalui [reaksi kimia](https://id.wikipedia.org/wiki/Reaksi_kimia) (misal H2O dipecah menjadi [hidrogen](https://id.wikipedia.org/wiki/Hidrogen) dan [oksigen](https://id.wikipedia.org/wiki/Oksigen) dengan cara [dielektrolisasi](https://id.wikipedia.org/w/index.php?title=Elektrolisasi&action=edit&redlink=1)). Ketika senyawa-senyawa ini berkumpul sangat banyak hingga pada tingkat yang bisa kita rasakan (dalam bentuk [padat](https://id.wikipedia.org/wiki/Padat), [cair](https://id.wikipedia.org/wiki/Cair), atau [gas](https://id.wikipedia.org/wiki/Gas)) maka akan disebut [zat](https://id.wikipedia.org/wiki/Zat) (misal kumpulan sangat banyak senyawa H2O akan terlihat sebagai air, es, atau uap air, begitu juga dengan kumpulan senyawa-senyawa NaCl yang kita kenal sebagai garam).

Senyawa pada dasarnya sama dengan [molekul](https://id.wikipedia.org/wiki/Molekul) (senyawa H2O disebut juga molekul H2O, dsb.) namun senyawa hanya bisa disebut senyawa jika terdiri dari dua atau lebih unsur yang **berbeda jenis**, oleh sebab itu [O2](https://id.wikipedia.org/wiki/O2), [O3](https://id.wikipedia.org/wiki/Ozon), [H2](https://id.wikipedia.org/wiki/H2) hanya disebut molekul dan bukan senyawa sebab hanya terdiri dari satu jenis atom saja. Kesimpulannya senyawa selalu berarti molekul, tetapi molekul tidak selalu berarti senyawa.

Perbedaan jenis-jenis senyawa bisa dilihat dari [rumus kimianya](https://id.wikipedia.org/wiki/Rumus_kimia). Rumus kimia/jumlah unsur dalam suatu senyawa bisa memengaruhi sifat dari suatu senyawa atau zat, perbedaan satu atau lebih atom saja bisa hasilkan senyawa yang berbeda dengan sifat yang berbeda pula (misal [etena](https://id.wikipedia.org/wiki/Etena) atau *ethylene* dengan rumus kimia [C](https://id.wikipedia.org/wiki/Karbon)2[H](https://id.wikipedia.org/wiki/Hidrogen)4 merupakan gas dan berbau harum sedangkan [metana](https://id.wikipedia.org/wiki/Metana) dengan rumus kimia [C](https://id.wikipedia.org/wiki/Karbon)[H](https://id.wikipedia.org/wiki/Hidrogen)4 merupakan gas namun tak berbau).

Zat terbagi ke dalam [zat murni](https://id.wikipedia.org/w/index.php?title=Zat_murni&action=edit&redlink=1) : ([unsur](https://id.wikipedia.org/wiki/Unsur) dan [senyawa](https://id.wikipedia.org/wiki/Senyawa)) serta [campuran](https://id.wikipedia.org/wiki/Campuran) : ([campuran serupa](https://id.wikipedia.org/w/index.php?title=Campuran_serupa&action=edit&redlink=1) dan [campuran beda rupa](https://id.wikipedia.org/w/index.php?title=Campuran_beda_rupa&action=edit&redlink=1)).

*Jumlah atom pada [ikatan kimia](https://id.wikipedia.org/wiki/Ikatan_kimia) dalam gambar telah disederhanakan sehingga tidak mewakili ikatan kimia sebenarnya. Warna atom ditambahkan untuk memudahkan pemahaman, kenyataannya atom tidak berwarna (kecuali pada beberapa jenis atom)*.

Benda-benda [logam paduan](https://id.wikipedia.org/wiki/Logam_paduan) seperti [kuningan](https://id.wikipedia.org/wiki/Kuningan_(logam)), [superkonduktor](https://id.wikipedia.org/wiki/Superkonduktor) [YBCO](https://en.wikipedia.org/wiki/YBCO), [semikonduktor](https://id.wikipedia.org/wiki/Semikonduktor) “[aluminium galium arsenida](https://id.wikipedia.org/wiki/Aluminium_galium_arsenida)” bukan merupakan senyawa/zat murni melainkan [campuran](https://id.wikipedia.org/wiki/Campuran), sebab merupakan gabungan dari dua atau lebih zat murni berbeda jenis (misal kuningan yang merupakan gabungan dari unsur tembaga dan unsur seng), begitu juga dengan [coklat](https://id.wikipedia.org/wiki/Coklat), kue, [rujak](https://id.wikipedia.org/wiki/Rujak), [semen](https://id.wikipedia.org/wiki/Semen), [udara](https://id.wikipedia.org/wiki/Udara), dll.

Senyawa dapat berwujud dalam tiga [fase](https://id.wikipedia.org/wiki/Fase_benda) atau keadaan, yaitu [padat](https://id.wikipedia.org/wiki/Padat), [cair](https://id.wikipedia.org/wiki/Cair), dan [gas](https://id.wikipedia.org/wiki/Gas). Kebanyakan senyawa berupa zat padat. Senyawa akan terurai atau terpisah-pisah bila dipanaskan sampai suhu atau tingkat panas tertentu yang disebut [suhu penguraian](https://id.wikipedia.org/w/index.php?title=Suhu_penguraian&action=edit&redlink=1) {misal ketika [tembaga karbonat](https://en.wikipedia.org/wiki/Copper(II)_carbonate) (CuCO3) dipanaskan hingga 290–330 °C, ia akan terurai menghasilkan [tembaga oksida](https://en.wikipedia.org/wiki/Copper(II)_oxide) (CuO) dan [karbon dioksida](https://id.wikipedia.org/wiki/Karbon_dioksida) (CO2)}.

Setiap senyawa kimia yang telah dijelaskan dalam literatur memiliki nomor pengenal khas yang dikenal sebagai [nomor CAS](https://id.wikipedia.org/wiki/Nomor_CAS).
## Molekul
...
## Ion
**Ion** adalah suatu [atom](https://id.wikipedia.org/wiki/Atom) atau [molekul](https://id.wikipedia.org/wiki/Molekul) yang memiliki [muatan listrik](https://id.wikipedia.org/wiki/Muatan_listrik) total tidak nol (jumlah total [elektron](https://id.wikipedia.org/wiki/Elektron) tidak sama dengan jumlah total [proton](https://id.wikipedia.org/wiki/Proton)). [Kation](https://id.wikipedia.org/wiki/Kation) adalah ion bermuatan positif, sedangkan [anion](https://id.wikipedia.org/wiki/Anion) adalah ion bermuatan negatif. Oleh karena itu, sebuah molekul kation memiliki sebuah proton hidrogen tanpa elektron, sedangkan anion memiliki elektron ekstra. Oleh karena muatan listriknya yang berlawanan, kation dan anion saling tertarik satu sama lain dan mudah membentuk [senyawa ionik](https://id.wikipedia.org/wiki/Senyawa_ionik).

Ion yang hanya berisi satu atom disebut [ion monoatomik](https://id.wikipedia.org/wiki/Ion_monoatomik) atau ion atomik, sementara yang berisi dua atau lebih atom membentuk ion molekuler atau [ion poliatomik](https://id.wikipedia.org/wiki/Ion_poliatomik). Dalam hal ionisasi fisik dalam suatu media, misalnya gas, “pasangan ion” tercipta dari tumbukan ion, di mana masing-masing pasangan yang terbentuk mengandung elektron bebas dan ion positif. Ion juga tercipta melalui interaksi kimia, misalnya pelarutan [garam](https://id.wikipedia.org/wiki/Garam_(kimia)) dalam cairan, atau dengan cara lain, melewatkan [arus searah](https://id.wikipedia.org/wiki/Arus_searah) melalui larutan penghantar yang melarutkan [anode](https://id.wikipedia.org/wiki/Anode) melalui [ionisasi](https://id.wikipedia.org/wiki/Ionisasi).
# 33. Kategori letak Proton, Neutron dan Electron
![[Pasted image 20250507232556.png]]
![[Pasted image 20250507232638.png]]
Konstituen terkecil dari semua materi normal dikenal sebagai [atom](https://id.wikipedia.org/wiki/Atom). Atom sangat kecil, berukuran sekitar sepersepuluh miliar meter; sehingga struktur internal mereka diatur oleh [mekanika kuantum](https://id.wikipedia.org/wiki/Mekanika_kuantum). Atom terdiri dari [nukleus](https://id.wikipedia.org/wiki/Inti_atom) bermuatan positif, terbuat dari [proton](https://id.wikipedia.org/wiki/Proton) bermuatan positif dan [neutron](https://id.wikipedia.org/wiki/Neutron) tidak bermuatan, dikelilingi oleh awan elektron bermuatan negatif; muatannya hilang, sehingga atom bersifat netral. Elektron berpartisipasi dalam [reaksi kimia](https://id.wikipedia.org/wiki/Reaksi_kimia), tetapi nukleus tidak. Ketika atom berpartisipasi dalam reaksi kimia, mereka dapat memperoleh atau kehilangan elektron untuk membentuk [ion](https://id.wikipedia.org/wiki/Ion) bermuatan positif atau negatif; atau mereka mungkin berbagi elektron satu sama lain sebagai gantinya.

Atom dapat dibagi lagi menjadi berbagai jenis berdasarkan jumlah proton (dan juga elektron) yang mereka miliki. Ini disebut [nomor atom](https://id.wikipedia.org/wiki/Nomor_atom), sering dilambangkan dengan *Z* karena dalam [bahasa Jerman](https://id.wikipedia.org/wiki/Bahasa_Jerman) nomor adalah *Zahl*. Setiap nomor atom berbeda karena itu sesuai dengan kelas atom: kelas ini disebut [unsur kimia](https://id.wikipedia.org/wiki/Unsur_kimia). Unsur-unsur kimia diklasifikasikan dan diatur oleh tabel periodik. [Hidrogen](https://id.wikipedia.org/wiki/Hidrogen) adalah unsur dengan nomor atom 1; [helium](https://id.wikipedia.org/wiki/Helium), nomor atom 2; [litium](https://id.wikipedia.org/wiki/Litium), nomor atom 3; dan seterusnya. Masing-masing nama ini selanjutnya dapat disingkat menjadi satu atau dua huruf, yang disebut dengan [lambang unsur](https://id.wikipedia.org/wiki/Lambang_unsur); untuk hidrogen, helium, dan litium berturut-turut adalah H, He, dan Li. Neutron tidak mempengaruhi identitas kimia atom, tetapi mempengaruhi beratnya. Atom dengan jumlah proton yang sama tetapi jumlah neutron yang berbeda disebut [isotop](https://id.wikipedia.org/wiki/Isotop) dari unsur kimia yang sama. Unsur-unsur alami biasanya terjadi sebagai campuran isotop yang berbeda; karena setiap isotop biasanya muncul dengan kelimpahan yang berkarakter, unsur-unsur yang terbentuk secara alami memiliki [massa atom](https://id.wikipedia.org/wiki/Massa_atom) yang terdefinisi dengan baik, yang didefinisikan sebagai massa rata-rata atom yang terbentuk secara alami dari unsur tersebut.

Saat ini, 118 unsur telah diketahui, dengan 94 unsur pertama diketahui terjadi secara alami di Bumi saat ini. Dari 94 unsur alami, 80 diantaranya memiliki isotop stabil; tiga lagi ([bismut](https://id.wikipedia.org/wiki/Bismut), [torium](https://id.wikipedia.org/wiki/Torium), dan [uranium](https://id.wikipedia.org/wiki/Uranium)) mengalami [peluruhan radioaktif](https://id.wikipedia.org/wiki/Peluruhan_radioaktif), tetapi sangat lambat sehingga sejumlah besar dapat bertahan dari pembentukan Bumi; dan sebelas peluruhan lainnya cukup cepat sehingga jejak mereka hanya bertumpu pada regenerasi konstan sebagai [produk peluruhan](https://id.wikipedia.org/wiki/Deret_radioaktif) thorium dan uranium. Ke-83 unsur yang bertahan dari pembentukan Bumi disebut [primordial](https://id.wikipedia.org/wiki/Nuklida_primordial). Semua 24 unsur buatan yang diketahui adalah radioaktif.
...
Menurut Taryono dalam buku *Pengantar Bioteknologi untuk Pemuliaan Tanaman* (2016), berikut [pengertian bioteknologi](https://www.kompas.com/tag/pengertian-bioteknologi):
...
Menurut Wikipedia, Polusi atau Pencemaran Udara adalah kehadiran satu atau lebih substansi [fisik](https://id.wikipedia.org/wiki/Fisik), [kimia](https://id.wikipedia.org/wiki/Kimia), atau [biologi](https://id.wikipedia.org/wiki/Biologi) di [atmosfer](https://id.wikipedia.org/wiki/Atmosfer) dalam jumlah yang dapat membahayakan kesehatan manusia, hewan, dan tumbuhan, mengganggu estetika dan kenyamanan, atau merusak properti.

Pencemaran udara dapat ditimbulkan oleh sumber-sumber alami maupun kegiatan manusia. Beberapa definisi gangguan fisik seperti [polusi suara](https://id.wikipedia.org/wiki/Polusi_suara), [panas](https://id.wikipedia.org/wiki/Panas), [radiasi](https://id.wikipedia.org/wiki/Radiasi) atau [polusi cahaya](https://id.wikipedia.org/wiki/Polusi_cahaya) dianggap sebagai polusi udara. Sifat alami udara mengakibatkan dampak pencemaran udara dapat bersifat langsung dan [lokal](https://id.wikipedia.org/wiki/Lokal), [regional](https://id.wikipedia.org/wiki/Regional), maupun [global](https://id.wikipedia.org/wiki/Global).

Substansi pencemar yang terdapat di udara dapat masuk ke dalam tubuh melalui [sistem pernapasan](https://id.wikipedia.org/wiki/Sistem_pernapasan). Jauhnya penetrasi zat pencemar ke dalam tubuh bergantung kepada jenis pencemar. Partikulat berukuran besar dapat tertahan di saluran pernapasan bagian atas, sedangkan partikulat berukuran kecil dan gas dapat mencapai paru-paru. Dari paru-paru, zat pencemar diserap oleh [sistem peredaran darah](https://id.wikipedia.org/wiki/Sistem_peredaran_darah) dan menyebar ke seluruh tubuh.

Dampak kesehatan yang paling umum dijumpai adalah [ISPA](https://id.wikipedia.org/w/index.php?title=ISNA&action=edit&redlink=1) (infeksi saluran pernapasan atas), termasuk di antaranya, [asma](https://id.wikipedia.org/wiki/Asma), [bronkitis](https://id.wikipedia.org/wiki/Bronkitis), dan gangguan pernapasan lainnya.

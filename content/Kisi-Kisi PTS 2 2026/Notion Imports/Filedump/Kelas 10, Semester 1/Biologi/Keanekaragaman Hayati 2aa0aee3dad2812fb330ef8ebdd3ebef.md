...
**Gen** ([serapan](https://id.wikipedia.org/wiki/Kata_serapan_dalam_bahasa_Indonesia) dari [bahasa Belanda](https://id.wikipedia.org/wiki/Bahasa_Belanda): *gen*) adalah unit pewarisan sifat bagi [organisme](https://id.wikipedia.org/wiki/Organisme) hidup. Bentuk fisiknya adalah urutan [DNA](https://id.wikipedia.org/wiki/DNA) yang melekat/berada di suatu [protein](https://id.wikipedia.org/wiki/Protein), [polipeptida](https://id.wikipedia.org/wiki/Polipeptida), atau seuntai [RNA](https://id.wikipedia.org/wiki/RNA) yang memiliki _f_ungsi bagi [organisme](https://id.wikipedia.org/wiki/Organisme) yang memilikinya. Batasan modern gen yaitu suatu [lokasi](https://id.wikipedia.org/wiki/Lokus_(genetika)) tertentu pada [genom](https://id.wikipedia.org/wiki/Genom) yang berhubungan dengan pewarisan sifat dan dapat dihubungkan dengan fungsi sebagai regulator (pengendali), sasaran [transkripsi](https://id.wikipedia.org/wiki/Transkripsi), atau peran-peran fungsional lainnya. Penggunaan “gen” dalam percakapan sehari-hari (misalnya “gen cerdas” atau “gen warna rambut”) sering kali dimaksudkan untuk [alel](https://id.wikipedia.org/wiki/Alel): pilihan variasi yang tersedia oleh suatu gen. Meskipun ekspresi alel dapat serupa, orang lebih sering menggunakan istilah [alel](https://id.wikipedia.org/wiki/Alel) untuk ekspresi gen yang secara [fenotipik](https://id.wikipedia.org/wiki/Fenotipe) berbeda. Gen disimbolkan dengan huruf. Gen dominan menggunakan huruf kapital sedangkan gen resesif menggunakan huruf kecil.

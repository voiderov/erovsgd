...
Istilah *server side scripting* merujuk pada proses pengolahan kode skrip yang berlangsung di sisi server. Teknik pengkodean ini berfungsi untuk memberikan tanggapan terhadap aktivitas *browsing* yang kamu lakukan di internet.

Skrip sisi server melibatkan penyematan *script* website yang di-*request* pengguna ketika *browsing*. Permintaan tersebut akan diproses dan direspons oleh server hingga hasilnya ditampilkan pada browser. Ada beberapa [bahasa pemrograman](https://www.dewaweb.com/blog/bahasa-pemrograman-paling-populer/) yang mendukung pengkodean sisi server, di antaranya termasuk [Python](https://www.dewaweb.com/blog/mengenal-bahasa-pemrograman-python/), PHP, Ruby, Java, [JavaScript](https://www.dewaweb.com/blog/mengenal-javascript/), dan Perl.

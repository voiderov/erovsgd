...
9. Contoh aplikasi *web server* adalah Apache Friend XAMPP.
...
13. Halaman WEB yang dinamakan *client web* adalah Front-End.
14. Urutan yang benar dalam membuat halaman *web* berbasis *server* adalah Jalankan web server > jalankan text editor > jalankan web browser.
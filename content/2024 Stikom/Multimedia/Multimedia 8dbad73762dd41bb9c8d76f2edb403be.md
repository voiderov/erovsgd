...
**Multimedia** adalah penyediaan informasi pada [komputer](https://id.wikipedia.org/wiki/Komputer) untuk menyajikan dan menggabungkan teks, [suara](https://id.wikipedia.org/wiki/Suara), gambar, [animasi](https://id.wikipedia.org/wiki/Animasi), [audio](https://id.wikipedia.org/wiki/Audio), dan [video](https://id.wikipedia.org/wiki/Video) dengan alat bantu (*tool*) dan tautan (*link*) sehingga pengguna dapat melakukan [navigasi](https://id.wikipedia.org/wiki/Navigasi), berinteraksi, berkarya, dan ber[komunikasi](https://id.wikipedia.org/wiki/Komunikasi). Multimedia sering digunakan dalam dunia informatika. Selain itu, multimedia juga digunakan dalam bidang-bidang lain seperti seni, pendidikan, hiburan, dan bisnis.
